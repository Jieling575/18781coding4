...
def get_parser(parser=None, required=True):
    ...
    parser.add_argument(
        "--train_json",
        type=str,
        default="dump/raw/train_bilingual/data.json",
        help="Filename of train label data (json)",
    )
    parser.add_argument(
        "--valid_json",
        type=str,
        default="dump/raw/dev_bilingual/data.json",
    ...
    ## Encoder related
    parser.add_argument(
        "--idim", type=int, default=80, help="Input Feature Size (don't need to change)"
    )
    parser.add_argument(
        "--hidden_dim",
        type=int,
    ...
    parser.add_argument(
        "--econformer_kernel_size",
        type=int,
        default=0,
        help="Conformer convolution size in encoder.",
    )
    parser.add_argument(
        "--eposition_embedding_type",
        type=str,
        default="absolute",
        help="Positional embedding class for encoder",
    )
